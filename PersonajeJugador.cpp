...
PersonajeJugador::PersonajeJugador(int x, int y, SDL_Renderer* renderer, list<Personaje*>*personajes)
{
    ...
    SDL_Texture* rayo2_textura = IMG_LoadTexture(renderer,  "assets/thunder_right1.png");
    rayo2_right.push_back(IMG_LoadTexture(renderer, "assets/thunder_right1.png"));


    rayo2_left.push_back(IMG_LoadTexture(renderer, "assets/thunder_left1.png"));


    rayo2_up.push_back(IMG_LoadTexture(renderer, "assets/thunder_up1.png"));


    rayo2_down.push_back(IMG_LoadTexture(renderer, "assets/thunder_down1.png"));
...
void PersonajeJugador::logic(Uint8* teclas_presionadas)
{
    ...
    if(teclas_presionadas[SDL_SCANCODE_E] && !rayo_activado && !rayo2_activado)
    {
